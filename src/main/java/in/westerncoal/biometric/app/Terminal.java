...
//import in.westerncoal.biometric.job.TerminalPool;
...
//	private TerminalOperation deviceOperation;
//	private boolean isDeviceOperationCompleted;
//
// 
//	
//	public void doDeviceRegisterReply(TerminalRegisterReply deviceRegisterReply,
//			TerminalPool biometricDevicePool) {
//		String reply;
//		try {
...
//	}
//
//	public void doSendLogReply(SendLogReply sendLogReply, WebSocket conn, TerminalPool biometricDevicePool) {
//		try {
//
//			String reply = BioUtil.getObjectMapper().writeValueAsString(sendLogReply);
//			conn.send(reply);
//			biometricDevicePool.getDevice(serialNo).setDeviceOperationCompleted(true);//Set Device Operation to complete
